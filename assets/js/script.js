...
let questionBank = [
    {
      ...
      options: ["Squab", "Squib", "Pigeot", "Pigchick"],
      answer: 0
    },
    {
      definition: "A word meaning confuse/perplex/fluster",
      options: ["Bumfuzzle", "Dumduffer", "Fuzzpop", "Conperflu"],
      answer: 0
    },
    {
      definition: "The art of engraving or carving whale ivory",
      options: ["Scrimshaw", "Whaleycarve", "Scriddle", "Blofrum"],
      answer: 0
    },
    {
      definition: "A song or melody that keeps repeating in one’s mind",
      options: ["Earworm", "Jinglebug", "Jazzfly", "Headnut"],
      answer: 0
    },
    {
    ...
    },
    {
      ...
      options: ["Brouhaha", "Quibbleschnort", "Hubbadubdub", "Frazzleblip"],
      answer: 0
    },
    {
      definition: "A foolish person",
      options: ["Nincompoop", "Fruzzleblip", "Blibberfloop", "Snickerdoodle"],
      answer: 0
    }
  ];